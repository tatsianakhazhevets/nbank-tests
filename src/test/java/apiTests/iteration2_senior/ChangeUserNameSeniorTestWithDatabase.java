...
import apiTests.iteration2_senior.models.ChangeUserNameResponse;
...
public class ChangeUserNameSeniorTestWithDatabase extends BaseTest {
    ...
    public void authorizedUserCanChangeNameSuccessfully() {
        ...
        CustomerDao customerDao = DataBaseStep.getUserProfileByUsername(user.getUsername());
        DaoAssertingClass.assertThat(changedUserName, customerDao).match();
        ...
        CustomerDao customerDaoTwiceResponse = DataBaseStep.getUserProfileByUsername(user.getUsername());
        DaoAssertingClass.assertThat( changeUserNameTwiceResponse, customerDaoTwiceResponse).match();
    }
    ...
    public void authorizedUserCannotChangeNameWithInvalidData(String name, String errorMessage) {
        ...
        CustomerDao customerDao = DataBaseStep.getUserProfileByUsername(user.getUsername());
        softly.assertThat(customerDao.getName()).isNull();
    }
}